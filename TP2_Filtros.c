...
#define ORDEN_LP_22K 126
#define ORDEN_LP_44K 126
#define ORDEN_LP_48K 137

#define ORDEN_HP_8K 144
#define ORDEN_HP_16K 130
#define ORDEN_HP_22K 156
#define ORDEN_HP_44K 194
#define ORDEN_HP_48K 178

#define ORDEN_BP_8K 203
#define ORDEN_BP_16K 215
#define ORDEN_BP_22K 218
#define ORDEN_BP_44K 234
#define ORDEN_BP_48K 255

#define ORDEN_BR_8K 356
#define ORDEN_BR_16K 494
#define ORDEN_BR_22K 532
#define ORDEN_BR_44K 532
#define ORDEN_BR_48K 582

// LÍNEAS NUEVAS ✅
#define FILTER_ORDER_MAX 582
arm_fir_instance_q15 filtro; // La estructura con toda la info del filtro (coef, linea de retardo)
q15_t fir_state_q15[FILTER_ORDER_MAX + 583]; // Línea de retardo o buffer de estado.
...
const q15_t fir_lp_22k[126 + 1] = {
	    ...
	    -59 }; //Frecuencia de paso 3400, de corte 3600, orden 126

const q15_t fir_lp_44k[126 + 1] = {
	    ...
	    -596 }; //Frecuencia de paso 3200, de corte 3600, orden 126
...
const q15_t fir_hp_8k[144 + 1] = {
	    ...
	    33, 36, 36, 36, 1203 }; // Frec de paso 100, de corte 35, orden 144

const q15_t fir_hp_16k[130 + 1] = {
	    ...
	    -108, -111, -115, -121, 895 }; //Frec de paso 180, de corte 35, orden 130

const q15_t fir_hp_22k[156 + 1] = {
	    ...
	    -134, -144, 757 }; //Frec de paso 200, de corte 35, orden 156

const q15_t fir_hp_44k[194 + 1] = {
	    ...
	    -72, -72, -69, -66, -66, -62, -59, -56, -56, -52, -49, -49, -544 };//Frec de paso 300, de corte 35, orden 194

const q15_t fir_hp_48k[178 + 1] = {
	    ...
	    -79, -75, -72, -69, -69, -66, -62, -59, -56, -56, -583 }; //Frec de paso 350, de corte 35, orden 178
...
const q15_t fir_bp_22k[218 + 1] = {
	    ...
	    -26, -72, -115, -121, -69, 26, 131, 197, 773 }; //Frec de paso 150 - 3300, de corte 35 - 3500, orden 218

const q15_t fir_bp_44k[234 + 1] = {
	    ...
	    -72, -69, -66, -66, -72, -79, -88, -108, -154, -249, 167 };//Frec de paso 250 - 3200, de corte 35 - 3500, orden 234
...
const q15_t fir_br_8k[356 + 1] = {
	    ...
	    43, 49, 52, 59, 62, 69, -963 }; //Frec de paso 20 - 80, de corte 42,5 - 57,5 (15 Hz con 50 entre medio), orden 356

const q15_t fir_br_16k[494 + 1] = {
	    ...
	    -865}; //Frec de paso 10 - 90, corte 42,5 - 57,5, orden 494

const q15_t fir_br_22k[532 + 1] = {
	    ...
	    52, 49, 49, 49, 46, 46, 43, 43, 39, 39, 36, 36, 36, 655 }; //Frec de paso 1-100, de corte 42,5 - 57,5, orden 532

const q15_t fir_br_44k[532 + 1] = {
	    ...
	    -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10,
	    -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10,
	    -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, -10, 2336 };//Frec de paso 1 - 100, frec de corte 42.5, 57.5, orden 532, Astop = 10 dB

const q15_t fir_br_48k[582 + 1] = {
	    ...
	    -7, -7, -7, -7, -7, -7, -7, -7, -7, -7, -7, -7, -7, -7,
	    2333 }; //Frec de paso 1 - 100, de corte 42.5, 57.5, orden 582, Astop 10 dB
...
int main(void) {
    ...
    PRINTF("Presione el botón RUN/STOP para comenzar");
			...
			if (ch != -1) {
						switch(ch) {
							case 'b': // Tecla 'b' para el Bypass
								fil_enable = !fil_enable; // Conmuta la bandera
								if (fil_enable) {
  ...
  LPADC_ClearStatusFlags(ADC0_PERIPHERAL, status_flag);
  	...
  	// Si la conversión del ADC está terminada, se guarda el dato en el buffer ajustado a q15
		...
		if(LPADC_GetConvResult(ADC0, &res, 0U)){
			...
			muestra_q15 = (int16_t)(muestra - 32768);
